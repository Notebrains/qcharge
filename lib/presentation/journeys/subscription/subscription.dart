...
import 'package:qcharge_flutter/data/models/my2c2psdk_response.dart';
...
class _SubscriptionState extends State {
                            ...
                            if (!isSubscriptionActive) {
                              if (subscriptionId.isEmpty) {
                                edgeAlert(context, title: 'Warning!',
                                    description: 'Please select one of the Subscription',
                                    gravity: Gravity.top);
                              } else {
                                Alert(
                                  context: context,
                                  title: "Payment Method",
                                  desc: "Select payment method for subscription",
                                  image: Padding(
                                    ...
                                    DialogButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        purchaseSubscriptionCubit.initiatePurchaseSubscription(
                                            _userId, 'transaction005', '10', 'wallet', subscriptionId,
                                        );
                              ...
                              Alert(
                                ...
                                desc: "Are you sure you want to cancel the subscription?",
                                image: Padding(
  ...
  void openPaymentGateway() async {
    try {
      ...
      sdk.uniqueTransactionCode = "10150919236";
